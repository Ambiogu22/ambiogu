            ...
            <div className='absolute z-40'>
                ...
                <div className='flex flex-col lg:flex-row justify-center items-center gap-4 lg:gap-12 mt-8 lg:mt-16'>
                    ...
                    <div className='flex mx-12 lg:flex-row gap-4 mb-12'>
                        ...
                        <div className='lg:p-2 lg:bg-white rounded-full flex items-center justify-center lg:hover:shadow-lg lg:hover:bg-gray-50 lg:rounded-lg transition-all duration-300 cursor-pointer'><img className='w-20 lg:w-12' title='CSS3' src={css3} alt='CSS3' /></div>
